...
-- Notices 테이블
-- =========================
INSERT INTO notices (title, content, status,pinned, admins_id, created_at, updated_at)
VALUES
    ('시스템 점검 안내', '2025년 12월 31일 오전 2시부터 4시까지 시스템 점검이 예정되어 있습니다.', true,true, 1, '2025-11-30 11:00:00', '2025-11-30 11:00:00'),
    ('서비스 런칭 이벤트', '새로운 서비스 런칭을 기념하여 이벤트를 진행합니다. 많은 참여 부탁드립니다.', true,false, 1, '2025-11-30 11:05:00', '2025-11-30 11:05:00'),
    ('이용 약관 개정 안내', '개정된 이용 약관에 대한 안내입니다. 상세 내용은 공지사항을 확인해주세요.', false,false, 2, '2025-11-30 11:10:00', '2025-11-30 11:10:00');